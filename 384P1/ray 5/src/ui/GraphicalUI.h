...
public:
	...
	Fl_Slider*			m_filterSlider;
        ...
        Fl_Check_Button*        m_antialiasingButton;
...
private:
	...
	static void cb_choose_cubemap(Fl_Menu_* o, void* v);
	...
	static void cb_refreshSlides(Fl_Widget* o, void* v);
        ...
        static void cb_filterWidth(Fl_Widget* o, void* v);
	...
	static void cb_bfCheckButton(Fl_Widget* o, void* v);
        static void cb_checkantialiasing(Fl_Widget* o, void* v);
	static void cb_checkcubemap(Fl_Widget* o, void* v);
        
        static void renderPixels(RayTracer * raytracer, const int& startx, const int& starty, const int& endx, const int& endy, const int& width, const int& height, const int& supersamplePixels);
