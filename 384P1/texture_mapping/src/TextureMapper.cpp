...
double noise2(Vec2d arg);
double noise3(Vec3d arg);
void init(void);
...
double noise1(double argg) {
   int bx0, bx1;
   double rx0, rx1, sx, t, u, v, arg[1];
